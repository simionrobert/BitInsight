...
class PeerDiscoveryM extends EventEmitter {

    constructor(opts) {
        super();
        if (!(this instanceof PeerDiscoveryM))
            return new PeerDiscoveryM(opts)
    ...
    lookup(infohash) {
        ...
        this.setInfohashTimeout(Buffer.from(infohash, 'hex'), this.timeout)
    }
