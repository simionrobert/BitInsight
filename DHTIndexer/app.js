...
DHTIndexer.prototype.onFindNodeResponse = function (nodes) {
...
DHTIndexer.prototype.sendFindNodeRequest = function (rinfo, nid) {
...
DHTIndexer.prototype.contactDHTNodes = function () {
...
DHTIndexer.prototype.onMessage = function (msg, rinfo) {
    try {
...
DHTIndexer.prototype.start = function () {
    ...
    setInterval(function () {
        ...
        this.contactDHTNodes();
    }.bind(this), 1000);
};

(new DHTIndexer({ address: '0.0.0.0', port: 6881 })).start();